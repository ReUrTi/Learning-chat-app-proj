...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT new com.example.chat_app.model.UserDTO(u.id, u.nickname) FROM User u WHERE LOWER(u.nickname) LIKE LOWER(CONCAT(:prefix, '%'))")
...
//    String getNicknameByUsername(@Param("username") String username);
    ...
    @Query("SELECT new com.example.chat_app.model.UserDTO(u.id, u.nickname) FROM User u WHERE u.username = :username")
